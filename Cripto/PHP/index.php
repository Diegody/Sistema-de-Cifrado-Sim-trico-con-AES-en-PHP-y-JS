...
<div class="container">
	<center><h1>Sistema de Cifrado Simétrico: <b>Chat</b></h1></center>
	<br>
				...
				<div id="sidepanel">
					<div id="profile">
						...
						foreach ($loggedUser as $user) {
							...
							echo '<img id="profile-img" src="../JPG/' . $user['avatar'] . '" class="online" alt="" />';
					...
					<div id="contacts">
						...
						foreach ($chatUsers as $user) {
							...
							echo '<img src="../JPG/' . $user['avatar'] . '" alt="" />';
							echo '<div class="meta">';
